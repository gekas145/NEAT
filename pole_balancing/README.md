...
On the right graph one can see that majority of the population has learned how to balance and was mainly loosing because of going off the field constraints. Learning of how to avoid the field edges was pretty hard as at the very beginning organisms only learn how to balance the pole and rarely get to the edges. There was a try to increase the reward if cart center remained "not far" from the field center, but it was only helpful for learning where the center is, not how to avoid the field edges.
